...
import { getTemplateStyle, generateClassNameStr } from '../../../../../utils/functions';
...
import GridUI from '../../grid/ui/GridUI';
...
const SectionUI = ({
  ...
  const { sectionCtx, myTemplatesCtx, myOverlayCtx, } = useContentCtx();
  const { hideOverlayArr, setHideOverlayArr } = usePagesCtx();
