...
const HeadingUI = ({type, headEleIdx, props, refBtn, gridIdxs, curEleSIndex, isMytemplate, isMyOverlay}:Prop) => {
    ...
    <Fragment>
      {
        ...
        (
          <span style={{color:"#000"}}><HeadingAtom refInner={refBtn} {...innerProps} /></span>          
        ):
        (
          <Fragment>
            {
            ...
            {
              <span id={`editor-out-container${headEleIdx}`} style={{ color:"#000", display:(showEditor?"none":"block") }} onClick={() => setShowEditor(true)} ><HeadingAtom refInner={refBtn} {...innerProps} /></span>
            }
          </Fragment>
        )
      }
