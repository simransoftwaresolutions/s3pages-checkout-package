      ...
      >
        ...
        >
          <div className="text-center mb-4">
            <i className="fa-sharp fa-solid fa-location-dot text-primary fs-3"></i>
            <h6 className="mt-2">Where is your business located?</h6>
          </div>
          <button
          ...
          <div className="text-center">
            <p className="mb-0">
              Website language <span className="text-primary">English</span>
            </p>
          </div>
        </div>
      </div>
