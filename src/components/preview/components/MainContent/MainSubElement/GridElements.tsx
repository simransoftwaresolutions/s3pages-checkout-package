...
import { useSettingsCtx } from "../../../../../context/preview/SettingsContext";
...
const GridElements: NextPage<Prop> = ({ gridIdx, viewState, idxs, eleData, columns, type, props, gridData, parentIdx, width, gridEle, gridMatrix, curEleSIndex, curEleCIndex = 0, refBtn}:Prop) => {
