...
import styles from '../../../../../styles/componentsettings/QueAnsStyleSelectorSettings.module.css';
...
interface QueAnsStyleSelctorProp {
  mClsName?:any;
  retHandle:any;
}

const QueAnsStyleSelectorSettings = ({mClsName, retHandle}:QueAnsStyleSelctorProp) => {

  const { getStyleOfElement } = useSettingsCtx();
  const { queryData, stylesCtx, stylesGlobCtx, activeDevice } = usePagesCtx();
