...
exports.getColorPickerFormAbstractClass = function (Form) {
    var ColorPickerFormAbstractClass = (function (_super) {
...
exports.getTextColorButtonClass = function (Form) {
    return (function (_super) {
        ...
        function TextColorButtonClass() {
            ...
            _this.name = 'bgcolor';
            _this.contentDefault = '<b style="background:#fff;color:#000;padding:2px;">A</b>';
            _this.aria = 'Background color';
        ...
        TextColorButtonClass.prototype._getCommandArgs = function (color) {
            return ['backColor', false, color, this.document.queryCommandValue('fontName')];
        };
